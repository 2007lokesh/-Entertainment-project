...
function Series() {
  ...
  const fetchSeries = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&page=${page}&sort_by=popularity.desc&with_genres=${genresUrl}`,
        options
      );
  ...
  return (
    <div>
      <span className="pageTitle"> TV and Series</span>
      <Genres
      type="tv"
        genres={genres}
        setGenres={setGenres}
